...
object Harvestable {
    ...
    const val POTATOES = "potato"
    const val CARROTS = "carrot"
    const val BEETROOTS = "beetroot"
    const val CACTUS = "cactus"
    const val SUGAR_CANE = "sugar_cane"
    ...
    const val GLOW_LICHEN = "glow_lichen"
    const val GLOW_BERRIES = "glow_berries"
    const val MOSS = "moss"
